...
namespace CodeGraph.Domain.Graph.TripleDefinitions.Nodes
{
    ...
    {
        public InvocationNode(MethodNode parentMethodNode, MethodNode methodNode) : base($"{parentMethodNode.FullName}->{methodNode.FullName}", $"{parentMethodNode.FullName}->{methodNode.FullName}")
        {
